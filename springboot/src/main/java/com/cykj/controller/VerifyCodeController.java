...
@RequestMapping(value = "/getCode")
   public void getCode(HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest, @RequestParam String random1){
        //声明验证码
        int width = 60;
        int height = 30;
        ...
        httpServletRequest.getSession().setAttribute("vCode",tempStr);
        //.. 生成图片发送到浏览器 --相当于下载
    try {
